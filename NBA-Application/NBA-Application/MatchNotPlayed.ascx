<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MatchNotPlayed.ascx.cs" Inherits="NBA_Application.WebUserControl1" %>
<div class="Match_not_played">
    <asp:Button ID="btnBuy" runat="server" Height="23px" Text="Buy Tickets" 
        Width="89px" />
